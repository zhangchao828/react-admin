const { __static, __nodeModules } = require('@zswl/shared/paths')
const webpack = require('webpack')
// const open = require('open')
const webpackDevConfig = require('./webpack.dev.config')
const getUnusedPort = require('@zswl/shared/getUnusedPort')
const message = require('@zswl/shared/message')
const { getConfig } = require('@zswl/shared/project')
const mock = require('@zswl/plugins/mock')
const createPage = require('@zswl/plugins/create-page')
